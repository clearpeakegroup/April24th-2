...
def batch_ingest_to_db(df, version=1, user=None, source="unknown"):
    """
    Deprecated: Use the Celery batch_ingest_task for ingestion with progress reporting.
    """
    raise NotImplementedError("Use the /ingest/batch endpoint and Celery task for ingestion.")
