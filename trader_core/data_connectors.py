...
class MarketDataConnector:
    ...
    def stream(self) -> Iterator[Dict[str, Any]]:
        ...
        """
        raise RuntimeError("stream() must be implemented by a subclass of MarketDataConnector.")
...
class WebSocketConnector(MarketDataConnector):
    ...
    def stream(self) -> Iterator[Dict[str, Any]]:
        ...
        """
        raise RuntimeError("WebSocketConnector is not yet implemented. Please use a supported connector.")
...
class BrokerAPIConnector(MarketDataConnector):
    ...
    def stream(self) -> Iterator[Dict[str, Any]]:
        ...
        """
        raise RuntimeError("BrokerAPIConnector is not yet implemented. Please use a supported connector.") 